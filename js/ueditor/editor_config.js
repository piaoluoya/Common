...
(function () {
    ...
    window.UEDITOR_CONFIG = {
       ...
       //,imageFieldName:"upfile"                   //图片数据的key,若此处修改，需要在后台对应文件修改对应参数
        ...
        ,toolbars:[["source","fontfamily","fontsize","bold","italic","forecolor","backcolor","justifycenter","justifyright","indent","insertorderedlist","insertunorderedlist","removeformat","pasteplain","insertimage","insertvideo","highlightcode","horizontal","link","unlink","anchor","searchreplace"]]
